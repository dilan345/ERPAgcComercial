<%@ Page Title="" Language="C#" MasterPageFile="~/Vistas/PaginasMaestras/Home.Master" AutoEventWireup="true" CodeBehind="NuevaCotizacion.aspx.cs" Inherits="ERP_Comercial.Vistas.Paginas.NuevaCotizacion" %>
                        ...
                        <nav class="navbar" style="background: transparent;">
                            <div class="container">
                                <form class="d-flex" role="search">
                                    ...
                                    <asp:ImageButton ID="Search" runat="server" class="Search" ImageUrl="~/Vistas/Estilos/Recursos/magnifying-glass-solid.svg" />
                                </form>
                            </div>
                        </nav>
                    </div>
